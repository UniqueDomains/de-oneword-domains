# Available .DE One-Word Domains (9,329)
...
> The full live catalog for this exact search currently contains **9,329 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,329 domains · **Median ask:** $8.70 · **High-demand under $2,500:** 3
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,329 live domains                         |
...
> Unique Domains. *Available .DE One-Word Domains*. Version 2026-09-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
