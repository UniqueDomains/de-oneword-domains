# Available .DE One-Word Domains (7,624)
...
> The full live catalog for this exact search currently contains **7,624 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 7,624 domains · **Median ask:** $9.35 · **High-demand under $2,500:** 2
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 7,624 live domains                         |
...
> Unique Domains. *Available .DE One-Word Domains*. Version 2026-08-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
