# Available .DE One-Word Domains (2,860)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-2%2C858%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-2%2C860%20domains-6f42c1">
...
> **Important:** this repository is a **public 2,858-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **2,860 domains** on the canonical page below.

**Public extract:** 2,858 rows · **Live catalog:** 2,860 domains
...
- `de.csv` — public CSV extract (2,858 rows)
- `de.json` — public JSON extract (2,858 rows)
...
| ----------------------- | ------------------------------------------------ |
| 2,858-row public sample | 2,860 live domains                               |
...
> Unique Domains. *Available .DE One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
