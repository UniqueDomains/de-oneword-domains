...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-2%2C859%20rows-8250df">
...
**Public extract:** 2,859 rows · **Live catalog:** 2,859 domains
...
- `de.csv` — public CSV extract (2,859 rows)
- `de.json` — public JSON extract (2,859 rows)
...
| ----------------------- | ------------------------------------------------ |
| 2,859-row public sample | 2,859 live domains                               |
...
> Unique Domains. *Available .DE One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
